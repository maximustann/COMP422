...
if __name__ == "__main__":
    ...
    write_file(result, "./data/default.csv", ["default"])
    ...
    for i in range(round_):
        ...
        #result[str(child)] = generation
        result.append([generation])
    write_file(result, "./data/large_pop.csv", ["large_pop"])
    ...
    write_file(result, "./data/large_mut.csv", ["large_mut"])
    population = 20
    crossrate = 0.8
    mutation_rate = 0.02
    result = []
    for i in range(round_):
        ...
        #result[str(child)] = generation
        result.append([generation])
    write_file(result, "./data/large_cro.csv", ["large_cro"])
