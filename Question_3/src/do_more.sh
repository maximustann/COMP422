...
paste result/mfeat_mor_ src/classes > result/mfeat_mor_final
...
cat src/variable_mor.txt result/mfeat_mor_test_fin.arff > result/mfeat-mor-test.arff
cat src/variable_mor.txt result/mfeat_mor_train_fin.arff > result/mfeat-mor-train.arff
