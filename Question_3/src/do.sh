...
paste result/mfeat_5 src/classes > result/mfeat_final
...
cat src/variable_define.txt result/mfeat_testing.arff > result/mfeat-test.arff
cat src/variable_define.txt result/mfeat_training.arff > result/mfeat-train.arff
